...
export default {
  ...
  created() {
    const PLUGINS_DATA_URL = "https://gcore.jsdelivr.net/gh/yokinanya/Loon-Gallery@master/data/plugins.json";
    const SOURCES_DATA_URL = "https://gcore.jsdelivr.net/gh/yokinanya/Loon-Gallery@master/data/repos.json";
